...
class MailingForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['channel'].initial = get_channel_by_slug(channel_slug)
        self.fields['actions'].queryset = get_actions_related_to_channel(
            channel_slug
        )
        self.fields['send_to'].queryset = Subscriber.objects.filter(
                    messengers_bot__channel=get_channel_by_slug(channel_slug),
                    is_active=True
                )
